...
public function traer_clientes(){
        $conexion = new Conexion();
        $query = "SELECT * FROM usuarios INNER JOIN personas on usuarios.Personas_idPersonas = personas.idPersonas INNER JOIN perfiles on usuarios.perfiles_idperfiles = perfiles.idperfiles WHERE perfiles.descripcion = 'Cliente' AND activo_usuario = 1 limit $this->pagina_actual,$this->paginacion";
        return $conexion->consultar($query);
}

public function traer_empleados(){
        $conexion = new Conexion();
        $query = "SELECT * FROM usuarios INNER JOIN personas on usuarios.Personas_idPersonas = personas.idPersonas INNER JOIN perfiles on usuarios.perfiles_idperfiles = perfiles.idperfiles WHERE perfiles.descripcion = 'Empleado' AND activo_usuario = 1 limit $this->pagina_actual,$this->paginacion";
        return $conexion->consultar($query);
}

...
$result_usuarios = $usuario->traer_empleados();
...
<div class="col">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <td>
                    <a href="index.php?page=listado_usuarios&idusuarios=<?=$usuario_['idusuarios']; ?>&nombre=<?=$usuario_['username'];?>" class="btn btn-success" type="button" title="Modificar Empleado">
        ...
        <nav aria-label="...">
            ...
            <li class="page-item <?php if($usuario->pagina_actual == 0){echo 'disabled';} ?>"> <!-- disabled -->
                <a class="page-link" href="index.php?page=listado_empleados&pagina_actual=<?= $usuario->pagina_actual - 1 ?>">Previo</a>
            </li>
            <li class="page-item"><a class="page-link" href="index.php?page=listado_empleados&pagina_actual=<?= $usuario->pagina_actual - 1 ?>"><?= $usuario->pagina_actual ?></a></li>
            <li class="page-item"><a class="page-link" href="index.php?page=listado_empleados&pagina_actual=<?= $usuario->pagina_actual ?>"><?= $usuario->pagina_actual + 1 ?></a></li>
            <li class="page-item"><a class="page-link" href="index.php?page=listado_empleados&pagina_actual=<?= $usuario->pagina_actual + 1 ?>"><?= $usuario->pagina_actual + 2 ?></a></li>
            <li class="page-item <?php if($usuario->pagina_actual == $total_registros - 1){echo 'disabled';} ?>">
                <a class="page-link" href="index.php?page=listado_empleados&pagina_actual=<?= $usuario->pagina_actual + 1 ?>">Siguiente</a>
            </li>
            </ul>
        </nav>
    </div>

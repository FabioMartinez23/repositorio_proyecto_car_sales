...
<body>
    <div class="container mt-5">
        <h1 class="text-center">Lista de Ventas de Autos</h1>
        <a type="button" href="index.php?page=registrar_ventas" class="btn btn-success mt-2 mb-2">Crear Nueva Venta</a>
            ...
            <tbody>
                ...
                foreach ($ventas as $venta) {
                    echo "<tr>
                            ...
                            <td>{$venta['fecha']}</td>
                            <td>
                                <a href='index.php?page=detalle_ventas&nro_venta={$venta['nro_venta']}' class='text-primary' title='Ver Más'>

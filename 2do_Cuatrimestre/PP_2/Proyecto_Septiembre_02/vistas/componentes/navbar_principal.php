...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link" href="index.php?page=nosotros">Quienes Somos</a>
            </li>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#">Simulador</a></li>
            </ul>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="index.php?page=login">Registrate</a>
            </li>
        </ul>
        </div>
    </div>
